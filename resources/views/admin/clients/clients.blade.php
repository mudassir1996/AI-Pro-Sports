                                           ...
                                           <td>
                                            <div class="media">
                                                <span class="justify-content-center">
                                                    <img src="{{Storage::disk('public')->exists('users/'.$client->profile_img)?$image=asset('storage/users/'.$client->profile_img):$image=asset('images/'.$client->profile_img)}}"  height="50" alt="">
                                                </span>
                                            </div>
                                           </td>
                                            <td>
